...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MovieViewHolder> {
    ...
    public SearchAdapter.MovieViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SearchAdapter.MovieViewHolder(itemView,mListener);
    }
    ...
    public SearchAdapter(Context context,Movies1.Movies movies1[]){
        mContext = context;
    ...
    public static class MovieViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        ImageView poster;
        SearchAdapter.MovieClickListener mMovieClickListener;

        public MovieViewHolder(View itemView,SearchAdapter.MovieClickListener listener) {
            super(itemView);
