...
public class Tv_TR_Adapter extends RecyclerView.Adapter<Tv_TR_Adapter.TvViewHolder> {

    private Context mContext;
    private TvShows1.TvShows mTvShows[];
    private Tv_TR_Adapter.MovieClickListener mListener;

    @Override
    public Tv_TR_Adapter.TvViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.row_layout,parent,false);
        return new Tv_TR_Adapter.TvViewHolder(itemView,mListener);
    }

    @Override
    public void onBindViewHolder(Tv_TR_Adapter.TvViewHolder holder, int position) {
    ...
    public Tv_TR_Adapter(Context context,TvShows1.TvShows TvShows1[]){
        mContext = context;
    ...
    public static class TvViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        ImageView poster;
        Tv_TR_Adapter.MovieClickListener mMovieClickListener;

        public TvViewHolder(View itemView,Tv_TR_Adapter.MovieClickListener listener) {
            super(itemView);
