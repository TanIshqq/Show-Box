...
public class Tv_Latest_Adapter extends RecyclerView.Adapter<Tv_Latest_Adapter.TvViewHolder> {

    private Context mContext;
    private TvShows1.TvShows mTvShows[];
    private Tv_Latest_Adapter.MovieClickListener mListener;

    @Override
    public Tv_Latest_Adapter.TvViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.row_layout,parent,false);
        return new Tv_Latest_Adapter.TvViewHolder(itemView,mListener);
    }

    @Override
    public void onBindViewHolder(Tv_Latest_Adapter.TvViewHolder holder, int position) {
    ...
    public Tv_Latest_Adapter(Context context,TvShows1.TvShows TvShows1[]){
        mContext = context;
    ...
    public static class TvViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        ImageView poster;
        Tv_Latest_Adapter.MovieClickListener mMovieClickListener;

        public TvViewHolder(View itemView,Tv_Latest_Adapter.MovieClickListener listener) {
            super(itemView);
