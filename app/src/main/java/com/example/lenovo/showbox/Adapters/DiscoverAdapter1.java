...
public class DiscoverAdapter1 extends RecyclerView.Adapter<DiscoverAdapter1.TvViewHolder> {
    ...
    public TvViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new TvViewHolder(itemView,mListener);
    }
    ...
    public DiscoverAdapter1(Context context,TvShows1.TvShows TvShows1[]){
        mContext = context;
    ...
    public static class TvViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public TvViewHolder(View itemView,MovieClickListener listener) {
            super(itemView);
